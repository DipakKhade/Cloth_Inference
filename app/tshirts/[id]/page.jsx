...
async function getProducts(){
  ...
  const tshirt_products=await getProducts();
  const tshirt=await tshirt_products["products"].filter((obj)=> obj._id == params.id)[0]

  const addtoCart=()=>{
    console.log(tshirt_products)
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                  <div className="flex">
                  <span className="mr-3" > Available Colors  : {tshirt.color}</span>
            <button className={`border-2 border-gray-300 ml-1 bg-${(tshirt.color).toLowerCase()}-700 rounded-full w-6 h-6 focus:outline-none`}></button>
                  </div>
